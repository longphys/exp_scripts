...
I=&J;
char str_Si[50]="/home/zhuhy/zhuhy/pid/pid_s_c/15C-Si.txt";
char str_CsI[50]="/home/zhuhy/zhuhy/pid/pid_s_c/15C-Si.txt";
_thick=1500;
AA=15;ZZ=6; openandreadandtest(thepid,se,AA,str_Si,str_CsI,_thick); //getit(f,se,AA,ZZ,I,_thick);
empty(se);
thepid->SetMarkerStyle(6);
thepid->SetMarkerColor(2);
thepid->Draw("samep");
