...
Double_t Ex_0=0,Ex_6600=6.094;
  for(Theta=20;Theta<60;Theta=Theta+0.1){
    for(Ex=0;Ex<20;Ex=Ex+0.05){
    Q=5.04-((15.0106/14.003241988-1.)*(_15C*15)+(3.0160492/14.003241988+1.)*Ex-2.*cos(Theta*3.14159/180.)*sqrt(15.0106*3.0160492*_15C*15*Ex)/14.003241988);
...
//E0为能量总值，E为能量实时记录值，E1为穿透第一块硅时的能量，E2为穿透第二块时的能量
  ...
  TString  str_1H[4];
  str_1H[0]=TString::Format("/home/zhuhy/JNBook/15C_Etheta/TAT0_datacheck/PID/txt/3H-CD2.txt");
  str_1H[1]=TString::Format("/home/zhuhy/JNBook/15C_Etheta/TAT0_datacheck/PID/txt/3H-Al.txt");
  str_1H[2]=TString::Format("/home/zhuhy/JNBook/15C_Etheta/TAT0_datacheck/PID/txt/3H-Si.txt");
  str_1H[2]=TString::Format("/home/zhuhy/JNBook/15C_Etheta/TAT0_datacheck/PID/txt/3H-CsI.txt");
...
for(num_ad3=stripnum;;num_ad3=15){
...
//cout<<" Y1"<<'\n';
 ...
 //    cout<<"Num="<<i<<'\t'<<"E="<<E0<<'\t'<<"dE_Si="<<sep[num_ad3][1][i]<<'\t'<<"dE_Mylar="<<sep[num_ad3][3][i]<<'\t'<<"dE_CsI="<<sep[num_ad3][4][i]<<'\n';
  ...
  Etheta_d[15]->SetMarkerColor(4);
  Etheta_d[15]->SetMarkerStyle(6);
  Etheta_d[15]->Draw("samep");
