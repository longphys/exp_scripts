...
I=&J;
char str_Si[50]="/home/zhuhy/zhuhy/pid/pid_s_c/14C-Si.txt";
char str_CsI[50]="/home/zhuhy/zhuhy/pid/pid_s_c/14C-Si.txt";
_thick=1600;
AA=14;ZZ=6; openandreadandtest(thepid,se,AA,str_Si,str_CsI,_thick); //getit(f,se,AA,ZZ,I,_thick);
empty(se);
