{
  ...
  ifstream ina2("/home/zhuhy/JNBook/Experiment2022/taf/check/angle/txt/thetatheta_C14H2_6500.txt");
  if(ina2.is_open()){
    getline(ina2,ssa);
    count_d_t_theta_theta_0_06=0;
    while(!ina2.eof())
    {
      ina2>>thetac>>theta;
      lisea_2->SetPoint(count_d_t_theta_theta_0_06++,thetac,theta);
    }
  }
  ina2.close();
