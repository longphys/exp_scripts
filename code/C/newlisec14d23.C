...
I=&J;
char str_Si[50]="/home/zhuhy/zhuhy/pid/pid_s_c/14B-Si.txt";
char str_CsI[50]="/home/zhuhy/zhuhy/pid/pid_s_c/14B-Si.txt";
_thick=1500;
AA=14;ZZ=5; openandreadandtest(thepid,se,AA,str_Si,str_CsI,_thick); //getit(f,se,AA,ZZ,I,_thick);
empty(se);
