...
I=&J;
char str_Si[50]="/home/zhuhy/zhuhy/pid/pid_s_c/12B-Si.txt";
char str_CsI[50]="/home/zhuhy/zhuhy/pid/pid_s_c/12B-Si.txt";
_thick=5500;
AA=12;ZZ=5; openandreadandtest(thepid,se,AA,str_Si,str_CsI,_thick); //getit(f,se,AA,ZZ,I,_thick);
empty(se);
