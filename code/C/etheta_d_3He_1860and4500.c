...
Double_t Ex_0=1.50,Ex_6600=5.11;

  ifstream ina("/home/zhuhy/JNBook/Experiment2022/taf/check/angle/txt/C15_d_3He_E_theta_1500.txt");
  string ssa;
  ...
  ifstream ina2("/home/zhuhy/JNBook/Experiment2022/taf/check/angle/txt/C15_d_3He_E_theta_5110.txt");
  if(ina2.is_open()){
    while(!ina2.eof())
    {
