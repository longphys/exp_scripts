{
  ...
  ifstream ina("/home/zhuhy/JNBook/Experiment2022/taf/check/angle/txt/thetatheta_B14He3_10000.txt");
  string ssa;
  ...
  ifstream ina2("/home/zhuhy/JNBook/Experiment2022/taf/check/angle/txt/thetatheta_B14He3_5500.txt");
  string ssa2;
  if(ina2.is_open()){
    getline(ina2,ssa2);
