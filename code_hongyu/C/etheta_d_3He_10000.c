...
Double_t Ex_0=10.,Ex_6600=10.;

  ifstream ina("/home/zhuhy/JNBook/Experiment2022/taf/check/angle/txt/C15_d_3He_E_theta_10000.txt");
  string ssa;
  ...
  ifstream ina2("/home/zhuhy/JNBook/Experiment2022/taf/check/angle/txt/C15_d_3He_E_theta_4500.txt");
  if(ina2.is_open()){
    while(!ina2.eof())
    {
