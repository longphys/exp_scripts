{
  ...
  ifstream ina("/home/zhuhy/JNBook/Experiment2022/taf/check/angle/txt/thetatheta_C14H3_0.txt");
  string ssa;
  ...
  ifstream ina2("/home/zhuhy/JNBook/Experiment2022/taf/check/angle/txt/thetatheta_C14H3_6600.txt");
  string ssa2;
  if(ina2.is_open()){
    getline(ina2,ssa2);
